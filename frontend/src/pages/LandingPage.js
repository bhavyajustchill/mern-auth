    ...
    <>
      <main>
            ...
            <div className="carousel-item active">
              ...
              <div className="container">
                <div className="carousel-caption text-start">
                  <h1>Example Landing Page for Public Non Authenticated Users.</h1>
                  <p className="opacity-75">BhavyaJustChill is the best Developer ever!</p>
                  <p>
            ...
            <div className="carousel-item">
              ...
              <div className="container">
                <div className="carousel-caption">
                  ...
                  <p>BhavyaJustChill is the most misunderstood guy to exist</p>
                  <p>
                    <a className="btn btn-lg btn-primary" href="#">
                      Learn more
                    </a>
        ...
        <footer className="container">
          ...
          <p>
            &copy; 2023 JustChill, Inc. &middot; <a href="#">Privacy</a> &middot;{" "}
            <a href="#">Terms</a>
          </p>
        </footer>
      </main>
